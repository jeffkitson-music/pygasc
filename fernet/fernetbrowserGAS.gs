// Same as fernetBrowser.js (https://github.com/csquared/fernet.js)
// To work in Google Apps Script (GAS) "global" statement removed from the first line

(function(e){if("function"==typeof bootstrap)bootstrap("fernet",e);else if("object"==typeof exports)module.exports=e();else if("function"==typeof define&&define.amd)define(e);else if("undefined"!=typeof ses){if(!ses.ok())return;ses.makeFernet=e}else"undefined"!=typeof window?window.fernet=e():fernet=e()})(function(){var define,ses,bootstrap,module,exports;
